...
$arguments = '--no-first-run --kiosk-idle-timeout-minutes=30 --kiosk http://myapps.microsoft.com/ https://cloud.contentraven.com/fisherpaykel/login https://www.google.com/ --edge-kiosk-type=public-browsing'
